...
CREATE TABLE contents(
        cafe_contentsno                           NUMBER(10)         NOT NULL         PRIMARY KEY,
        cafe_mno                              NUMBER(10)     NOT NULL , -- FK
        cafeno                                NUMBER(10)         NOT NULL , -- FK
        ...
        FOREIGN KEY (cafe_mno) REFERENCES member (cafe_mno),
        FOREIGN KEY (cafeno) REFERENCES cafe (cafeno)
);

COMMENT ON TABLE contents is '컨텐츠 - 순례길';
COMMENT ON COLUMN contents.cafe_contentsno is '컨텐츠 번호';
COMMENT ON COLUMN contents.cafe_mno is '관리자 번호';
COMMENT ON COLUMN contents.cafeno is '카테고리 번호';
...
INSERT INTO contents(cafe_contentsno, cafe_mno, cafeno, title, content, recom, cnt, replycnt, passwd, 
...
-- 유형 1 전체 목록
SELECT cafe_contentsno, cafe_mno, cafeno, title, content, recom, cnt, replycnt, passwd, word, rdate,
           file1, file1saved, thumb1, size1
FROM contents
ORDER BY cafe_contentsno DESC;
